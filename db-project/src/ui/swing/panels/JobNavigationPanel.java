...
public class JobNavigationPanel extends JPanel {
	 ...
	 * Create the panel.
	 */
	public JobNavigationPanel(List<Job> list) {
	...
	private void updateList(List<Job> list) {
		this.list = list;
		setCurrentIndex(0);
	...
	public class ListListener implements PropertyChangeListener {
		...
		public void propertyChange(PropertyChangeEvent evt) {
			if (evt.getPropertyName().equals("personList")) {
				updateList( (List<Job>)evt.getNewValue() );
			}
		}
	}
}
